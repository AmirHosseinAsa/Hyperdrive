...
public class Menu : MonoBehaviour
{
    ...
    public void SetRaceSettings()
    {
        if (menuScreen == MenuScreens.levels)
        {
            ...
            switch (selectedLevel)
            {
                ...
                case 6: mapName = MapNames.Rural; raceMode = RaceModes.Escape; break;
                case 7: mapName = MapNames.Desert; raceMode = RaceModes.Special; break;
                case 8: mapName = MapNames.Urban; raceMode = RaceModes.Classic; break;
                case 9: mapName = MapNames.Artic; raceMode = RaceModes.Infection; break;
        ...
        {
            case GameTypes.play:
                difficultyType = DifficultyTypes.Easy; numLaps = 3; numCars = 4;
                switch (selectedLevel)
                {
                    case 3: difficultyType = DifficultyTypes.Normal; numLaps = 3; numCars = 4; break;
                    case 4: difficultyType = DifficultyTypes.Normal; numLaps = 3; numCars = 5; break;
                    case 5: difficultyType = DifficultyTypes.Normal; numLaps = 4; numCars = 5; break;
    ...
    private void MainMenuKeyPress()
    {
        ...
        else if (Input.GetKeyDown(KeyCode.Escape) || Input.GetKeyDown(KeyCode.JoystickButton7) && (!windowOpen))
    ...
    private void RaceSettingsMenuKeyPress()
    {
        ...
        { SelectCar(); music.PlayClickSound(); }
        else if ((Input.GetKeyDown(KeyCode.Escape) || Input.GetKeyDown(KeyCode.JoystickButton7)) && (gameType == GameTypes.quickRace1P))
        { ClickQuickRace1P(); music.PlayClickSound(); }
        else if ((Input.GetKeyDown(KeyCode.Escape) || Input.GetKeyDown(KeyCode.JoystickButton7)) && (gameType == GameTypes.quickRace2P))
    ...
    private void CarMenuKeyPress()
    {
        ...
        else if ((Input.GetKeyDown(KeyCode.Escape) || Input.GetKeyDown(KeyCode.JoystickButton7)) && (gameType == GameTypes.play))
        { ClickPlay(); music.PlayClickSound(); }
        else if ((Input.GetKeyDown(KeyCode.Escape) || Input.GetKeyDown(KeyCode.JoystickButton7)) && (gameType != GameTypes.play))
        { SetQuickRaceSettings(); music.PlayClickSound(); }
