    ...
    private IEnumerator ShowRaceResults()
    {
        ...
        if ((gameType == Menu.GameTypes.play) && (resultsStars[3].activeSelf))
        {
            ...
            switch (selectedLevel)
            {
                ...
                case 5:
                    Debug.Log("should initial level 6");
                    if (PlayerPrefs.GetInt("Level6", 0) == 1) { break; }
                    PlayerPrefs.SetInt("Level6", 1);
                    resultsText[20].text = "NEW LEVEL UNLOCKED";
                    resultsText[21].text = "LEVEL 6";
                    break;

                case 6:
                    if (PlayerPrefs.GetInt("Level7", 0) == 1 && PlayerPrefs.GetInt("Car3", 0) == 1) { break; }
                    PlayerPrefs.SetInt("Level7", 1);
                    PlayerPrefs.SetInt("Car3", 1);
                    resultsText[20].text = "NEW LEVEL AND CAR UNLOCKED";
                    resultsText[21].text = "LEVEL 7, Car: " + GameManager.instance.cars[3].name;
                    break;

                case 7:
                    if (PlayerPrefs.GetInt("Level8", 0) == 1) { break; }
